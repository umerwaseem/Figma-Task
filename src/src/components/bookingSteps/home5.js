    ...
    <div className="bookingSteps">
      <Col className="bookingCol1">
        ...
        <Row>
          ...
          <Col><h3>Choose Destination</h3>
          <p>Choose your favourite place. No matter
where you travel inside the World.</p></Col>
        </Row>
        <Row>
        ...
        <Col><h3>Make Payment</h3>
          <p>After find your perfect spot, make your
payment and get ready to travel.</p></Col>
      </Row>
      <Row>
        ...
        <Col><h3>Reach Airport on Selected Date</h3>
          <p>Lastly, you have to arrive at the airport
on time and enjoy the vacation.</p></Col>
      </Row>
